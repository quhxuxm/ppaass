...
use crate::constant::{DEFAULT_AGENT_SERVER_PORT, DEFAULT_RSA_DIR, DEFAULT_THREAD_NUMBER};
...
impl AgentServerConfig {
    ...
    pub(crate) fn get_port(&self) -> u16 {
        self.port.unwrap_or(DEFAULT_AGENT_SERVER_PORT)
    }
...
#[derive(Serialize, Deserialize, Debug, Default)]
pub(crate) struct AgentServerLogConfig {
    /// The log directory
    dir: Option<String>,
